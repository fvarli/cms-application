        ...
        <div class="row">
            <div class="col-md-12">
                                ...
                                <div id="slider-banner-boxedwidth" class="slider-banner-boxedwidth rev_slider" data-version="5.0">
                                    <ul class="slides">
                                        ...
                                        <?php foreach ($product_images as $image) {?>
                                            ...
                                            <!-- main image -->
                                            <img src="<?php echo base_url("panel/uploads/products_view/$image->img_url");?>" alt="<?php echo $product->title;?>" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
                ...
                <section class="section pv-40 clearfix">
                    <div class="container">
                        <h3 class="mt-3">Related <strong>Products</strong></h3>
