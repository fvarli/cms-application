                    ...
                    <div class="col-md-auto hidden-md-down pl-3">
                        ...
                        <div class="header-first clearfix">
                            ...
                            <div id="logo" class="logo">
                                <a href="index.html"><img id="logo_img" src="<?php echo base_url("assets/images");?>/logo_blue.png" alt="The Project"></a>
                            </div>
                                ...
                                <nav class="navbar navbar-expand-lg navbar-light p-0">
                                    <div class="navbar-brand clearfix hidden-lg-up">
                                        ...
                                        <div id="logo-mobile" class="logo">
                                            <a href="index.html"><img id="logo-img-mobile" src="<?php echo base_url("assets/images");?>/logo_blue.png" alt="The Project"></a>
                                        </div>
                                            ...
                                            <li class="nav-item dropdown ">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="fifth-dropdown">
                                                    ...
                                                    <li class="dropdown ">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li ><a href="portfolio-list-1.html">List - Large <?php echo base_url("assets/images");?></a></li>
                                                            <li ><a href="portfolio-list-2.html">List - Small <?php echo base_url("assets/images");?></a></li>
