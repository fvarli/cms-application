    ...
    <div class="banner clearfix">
        ...
        <?php $this->load->view("{$view_folder}/slider"); ?>
    ...
    <?php $this->load->view("{$view_folder}/about_us"); ?>

    <?php $this->load->view("{$view_folder}/services"); ?>

    <?php $this->load->view("{$view_folder}/testimonials"); ?>

    <?php $this->load->view("{$view_folder}/portfolios"); ?>


    <?php $this->load->view("{$view_folder}/references"); ?>
