                ...
                <table class="table table-hover table-bordered table-striped table-container">
                    ...
                    <?php  foreach($items as $item) { ?>
                        ...
                        <td class="text-center">
                                <img width="100" src="<?php echo get_picture_to_size($viewFolder, $item->img_url, "350x217");?>" alt="" class="img-rounded">
                        </td>
                        <td class="text-center">
                        <label class="switch">
                        <input
                        ...
                        <td class="w250">
                            <?php if(is_allowed_delete_module()) { ?>
                                <button
                                        data-url="<?php echo base_url("services/delete_record/$item->id");?>"
