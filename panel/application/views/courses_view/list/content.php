...
<div class="row">
    ...
    <div class="row">
        <div class="col-md-12">
            <h4 class="m-b-lg">
                Course List
                <a href="<?php echo base_url("courses/add_new_course");?>" class="btn-outline btn-primary btn-xs pull-right"><i class="fa fa-plus"></i>Add New</a>
            </h4>
        </div><!-- END column -->
        ...
        <div class="col-md-12">
            ...
            <div class="widget p-lg">
                ...
                <div class="alert alert-info">
                    ...
                    <p>There is no data. Please <a href="<?php echo base_url("courses/add_new_course");?>"><font color="#00008b">click here</font></a> to add data.</p>
                </div>
                ...
                <table class="table table-hover table-bordered table-striped table-container">
                    ...
                    <?php  foreach($items as $item) { ?>
                        ...
                        <td class="w250">
                            <button
                                    data-url="<?php echo base_url("courses/delete_course/$item->id");?>"
                                    class="btn btn-sm btn-danger btn-remove">
                                    <i class="fa fa-trash"></i> Delete
                            </button>
                            <a href="<?php echo base_url("courses/update_existing_course/$item->id");?>" class="btn btn-sm btn-info"><i class="fa fa-pencil-square-o"></i> Edit</a>
                        </td>
                    </tr>
