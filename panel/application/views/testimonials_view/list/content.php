        ...
        <div class="col-md-12">
            <h4 class="m-b-lg">
                ...
                <?php if(is_allowed_write_module()) { ?>
                    <a href="<?php echo base_url("testimonials/add_new_testimonial");?>" class="btn-outline btn-primary btn-xs pull-right"><i class="fa fa-plus"></i>Add New</a>
                <?php } ?>
            </h4>
        </div><!-- END column -->
                ...
                <?php if(empty($items)) { ?>
                    <?php if(is_allowed_write_module()) { ?>
                        ...
                        <div class="alert alert-info">
                            ...
                            <p>There is no data. Please <a href="<?php echo base_url("testimonials/add_new_testimonial");?>"><font color="#00008b">click here</font></a> to add data.</p>
                        </div>
                    <?php } ?>
                    ...
                    <?php  foreach($items as $item) { ?>
                        ...
                        <td class="w250">
                            <?php if(is_allowed_delete_module()) { ?>
                                <button
                                        data-url="<?php echo base_url("testimonials/delete_record/$item->id");?>"
